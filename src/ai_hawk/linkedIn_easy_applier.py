...
# FIXME: put this function somewhere that it belongs, such as a QuestionManager class or something
...
class AIHawkEasyApplier:
    def __init__(self, driver: Any, resume_dir: Optional[str],
                 set_old_answers: List[Tuple[str, str, str]],
                 gpt_answerer: Any, resume_generator_manager):
        # Things like this are very redundant and clutters the log. Objects should never fail initialization.
    ...
    def _create_and_upload_cover_letter(self, element: WebElement, job) -> None:
        logger.debug(
            "Starting the process of creating and uploading cover letter.")
