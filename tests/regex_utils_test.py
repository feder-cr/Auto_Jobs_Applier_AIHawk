...
test_cases = [
    ...
    (
        ...
        True,
    ),  # Location with city and country (blacklist)
    ...
    (
        ...
        "USA",
        False,
    ),  # Variants on corporation, part of a different word
...
def test_is_blacklisted(job_title, company, link, job_location, expected_output):
    ...
    ), f"Failed for case: {job_title} at {company} in {job_location} (link: {link})"
