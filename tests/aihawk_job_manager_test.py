...
def test_get_jobs_from_page_with_jobs(mocker, job_manager):
    ...
    mocker.patch.object(job_manager.driver, "find_element", return_value=mock_no_jobs_element)

    # Mock the page_source
    mocker.patch.object(job_manager.driver, "page_source", return_value="some page content")
...
def test_apply_jobs_with_jobs(mocker, job_manager):
    ...
    mocker.patch.object(job_manager.driver, "find_element", return_value=no_jobs_element)

    # Mock the page_source to simulate what the page looks like when jobs are present
    mocker.patch.object(job_manager.driver, "page_source", return_value="some job content")
